...
const Icon = () => null;
const Card = new Function("React", "MessageCircle", "ChevronRight", "confirmationTelegramUrl", `${transformed.code}; return Card;`)(React, Icon, Icon, confirmationTelegramUrl);
...
const MissingCard = new Function("React", "MessageCircle", "ChevronRight", "confirmationTelegramUrl", `${transformed.code}; return Card;`)(React, Icon, Icon, "");
